...
| Rank | Model / Submission | Lead Team / Affiliation | Core Architectural Mechanism | Mean Lesion DSC | False Positive Vol (FPV) | Award / Citation |
| :---: | :--- | :--- | :--- | :---: | :---: | :--- |
| **1** | **nnU-Net Dual-Stream (PET-CT)** | Fabian Isensee et al. (MIC-DKFZ) | Independent encoder branches for SUV and CT with multi-scale cross-attention fusion and hard false-positive suppression | **0.784** | **1.82 mL** | **Engineering Contribution Award** [MICCAI 2023](https://doi.org/10.1007/978-3-031-43904-9) |
| **2** | **Domain-Invariant SegResNet** | Adrian Galdran et al. (University of Adelaide) | Modality-specific instance normalization with spatial intensity dropout to resist site-shift | **0.776** | **2.05 mL** | **Scientific Contribution Award** [autoPET II](https://autopet-ii.grand-challenge.org/) |
| **3** | **SwinUNETR Multi-Modal** | NVIDIA Medtech Consortium | 3D hierarchical transformer processing concatenated 2-channel SUV+CT feature tokens | **0.768** | **2.34 mL** | [Grand Challenge Proceedings](https://autopet.grand-challenge.org/) |
| **4** | **Dual-Stream DINOv3 (Adapted)** | MIDL 2026 Academic Study | Dual-path vision foundation model adapted for metabolic tumor localization | **0.759** | **2.61 mL** | [MIDL 2026 / S77](https://doi.org/10.1038/s41551-026-01741-4) |
| **5** | **Standard 3D nnU-Net Baseline** | Challenge Organizers (Gatidis et al.) | Concatenated 2-channel 3D fullres nnU-Net without specialized physiological masking | **0.742** | **3.85 mL** | [Radiology: AI 2022](https://doi.org/10.1148/ryai.220087) |
