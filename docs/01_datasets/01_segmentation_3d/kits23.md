...
| Rank | Model / Submission | Team / Affiliation | Core Architecture & Strategy | Overall Mean Dice | Surface Dice (NSD) | Tumor Dice (Tiebreaker) | Reference / Links |
| :---: | :--- | :--- | :--- | :---: | :---: | :---: | :--- |
| **1** | **Auto3DSeg Ensemble** | Andriy Myronenko et al. (NVIDIA) | 15-model ensemble combining SegResNet, DiNTS (NAS), and SwinUNETR with test-time augmentation | **0.835** | **0.723** | **0.792** | [arXiv:2309.07348](https://arxiv.org/abs/2309.07348) |
| **2** | **Cascaded ResEnc-UNet** | Kwang-Hyun Uhm et al. (Korea University) | Two-stage coarse-to-fine residual encoder U-Net with anisotropic patch resampling | **0.820** | **0.712** | **0.768** | [KiTS23 Proceedings](https://kits-challenge.org/kits23/) |
| **3** | **Boundary-Guided DynUNet** | Yasmeen George et al. (Monash University) | DynUNet with deep supervision, compound focal/top-k cross-entropy loss, and contour regularization | **0.819** | **0.707** | **0.761** | [KiTS23 Proceedings](https://kits-challenge.org/kits23/) |
| **4** | **3D UX-Net + Anisotropic Attention** | Shuolin Liu et al. (Independent) | Large-kernel volumetric convolutional network with depthwise separable convolutions | **0.812** | **0.698** | **0.754** | Grand Challenge Submission |
| **5** | **Standard nnU-Net v2 Baseline** | MIC-DKFZ / Challenge Organizers | Self-configuring 3D full-resolution nnU-Net v2 (5-fold cross-validation ensemble) | **0.804** | **0.689** | **0.742** | [Nature Methods 18](https://doi.org/10.1038/s41592-020-01008-z) |
