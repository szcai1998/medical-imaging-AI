...
- **Evidence Code:** `E1` (Peer-Reviewed Challenge Descriptor in MedIA) + `E2` (Official Challenge Portal)
...
| Rank | Model / Framework | Developing Team | Core Architectural Innovation | Evaluation Split & Setting | Official CPM Score | Sens. @ 1 FP/scan | Sens. @ 2 FP/scan | Reference |
| :---: | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :--- |
| **1** | **DeepLung (3D Dual-Path ResNet)** | Wentao Zhu et al. (UC Irvine) | 3D Faster R-CNN with dual-path residual blocks and deep focal loss | Official 10-Fold Cross-Validation | **0.958** | **0.942** | **0.961** | [IEEE TMI 37](https://doi.org/10.1109/TMI.2018.2833446) |
| **2** | **nnDetection / nnU-Net CAD** | Michael Baumgartner et al. (DKFZ) | Self-configuring 3D object detection framework tailored for anisotropic volumetric medical data | Official 10-Fold Cross-Validation | **0.952** | **0.938** | **0.957** | [Nature Methods 18](https://doi.org/10.1038/s41592-021-01297-6) |
| **3** | **Multi-Crop 3D CNN Ensemble** | Jia Ding et al. (Tsinghua / Tencent) | Multi-scale contextual patch cropping with candidate feature fusion | Official 10-Fold Cross-Validation | **0.944** | **0.925** | **0.949** | [IEEE TMI 2017](https://doi.org/10.1109/TMI.2017.2725580) |
| **4** | **3D DCNN + Multi-Resolution** | Arnaud Setio et al. (Radboud UMC) | Multi-view 2D/3D convolutional ensemble with aggressive hard negative mining | Official 10-Fold Cross-Validation | **0.938** | **0.916** | **0.942** | [IEEE TMI 35](https://doi.org/10.1109/TMI.2016.2536809) |
| **5** | **Classic Diagnostic Baseline** | Challenge Organizers | Multi-stage CAD system using morphological hand-crafted filters + SVM | Official 10-Fold Cross-Validation | **0.824** | **0.782** | **0.820** | [Medical Image Analysis 42](https://doi.org/10.1016/j.media.2017.06.015) |
...
- **Minimal Local Verification / Load Command:**
  ```python
  # Requirements: pip install SimpleITK
...
- **LCTfound** (`docs/02_models/02_volumetric_ct_mri/lctfound.md`): Lung CT organ-specialist foundation model.
- **CT-CLIP / CT-CHAT** (`docs/02_models/02_volumetric_ct_mri/ct_clip_chat.md`): 3D pulmonary abnormality classification.
